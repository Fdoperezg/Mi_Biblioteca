...
class LibrosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post libros_url, params: { libro: { autor: @libro.autor, devuelto: @libro.devuelto, estado: @libro.estado, prestado: @libro.prestado, title: @libro.title } }
    end
  ...
  test "should update libro" do
    patch libro_url(@libro), params: { libro: { autor: @libro.autor, devuelto: @libro.devuelto, estado: @libro.estado, prestado: @libro.prestado, title: @libro.title } }
